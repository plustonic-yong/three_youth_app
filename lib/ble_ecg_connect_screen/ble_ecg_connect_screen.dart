...
class BleECGConnectScreenState extends State<BleECGConnectScreen> {
            ...
            : Center(
                child: Column(
                  children: [
                    ...
                    (isTest == 0) ? getStartButton() :
                    (isTest == 1) ? getStopButton() : getResult(),
                    //
                    // const SizedBox(
                    //   height: 20,
                    // ),
            ...
            if (r.device.name.startsWith(sBLEDevice)) {
              ...
              if (bleDevice == null) {
                ...
                services.forEach((service) async {
                  print(
                      '####### Service UUID = ${service.uuid.toString()}');
                  ...
                  if (service.uuid.toString().toUpperCase() ==
                    ...
                    in characteristics) {
                      print(
                          '####### Character UUID = ${c.uuid.toString()}');
              ...
              children: [
                CommonButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const HistoryAppScreen()),
                      );
  ...
  Future<void> doTestSave() async {
    ...
    sql += " '${testID}', '${ff.format(dtStart)}', '${ff.format(dtStop)}', ${lsData.length}";
    sql += ") ";
