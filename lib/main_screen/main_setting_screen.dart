...
import 'package:three_youth_app/base/simple_dialog.dart';
import 'package:three_youth_app/base/spinkit.dart';
import 'package:three_youth_app/custom/common_button.dart';
import 'package:three_youth_app/history_screen/locallog_appscreen.dart';
            ...
            children: [
              ...
              CommonButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const LocalLogAppScreen()),
                  );
                },
              ),
              const SizedBox(
