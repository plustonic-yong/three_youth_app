...
class ElectrocardiogramSettingScreen extends StatefulWidget {
  ...
  @override
  _ElectrocardiogramSettingScreenState createState() =>
      _ElectrocardiogramSettingScreenState();
}

class _ElectrocardiogramSettingScreenState
    extends State<ElectrocardiogramSettingScreen> {
  bool isLoading = true;
  // ignore: unused_field
                    ...
                    CommonButton(
                        ...
                        onPressed: () async {
                          await prefs.setString(
                              'ecgpincode', _nameController.text);
                        }),
                  ],
                ),
              ),
