...
class SphygmomanometerSettingScreen extends StatefulWidget {
  ...
  @override
  _SphygmomanometerSettingScreenState createState() =>
      _SphygmomanometerSettingScreenState();
}

class _SphygmomanometerSettingScreenState
    extends State<SphygmomanometerSettingScreen> {
  bool isLoading = true;
  // ignore: unused_field
