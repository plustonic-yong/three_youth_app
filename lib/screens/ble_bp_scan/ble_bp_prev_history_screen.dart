...
class BleBpPrevHistoryScreen extends StatefulWidget {
  const BleBpPrevHistoryScreen({Key? key}) : super(key: key);

  @override
  State<BleBpPrevHistoryScreen> createState() => _BleBpPrevHistoryScreenState();
}

class _BleBpPrevHistoryScreenState extends State<BleBpPrevHistoryScreen> {
  @override
  void initState() {
