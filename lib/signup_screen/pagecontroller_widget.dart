          ...
          child: GradientSmallButton(
            ...
            onPressed: () {
              if (widget1 != null) {
                ...
                Provider.of<CurrentUser>(context, listen: false).isMale = isMale!;
                Provider.of<CurrentUser>(context, listen: false).name = name!;
                Provider.of<CurrentUser>(context, listen: false).height = height!;
                Provider.of<CurrentUser>(context, listen: false).weight = weight!;
                Provider.of<CurrentUser>(context, listen: false).birthDate = birthDate!;
        ...
        Container(
          ...
          child: GradientSmallButton(
            ...
            gradient: LinearGradient(
              ...
              colors: isAble ? <Color>[ColorAssets.greenGradient1, ColorAssets.purpleGradient2] : <Color>[Colors.grey, Colors.grey],
            ),
            onPressed: () async {
