...
class _SignupScreen2State extends State<SignupScreen2> {
  ...
  final GlobalKey<FormFieldState> _passwordFormKey2 = GlobalKey<FormFieldState>();
  ...
  void initState() {
    Future.delayed(Duration.zero, () async {
      setState(() {
        ...
        _emailController.text = Provider.of<CurrentUser>(context, listen: false).id;
        _passwordController.text = Provider.of<CurrentUser>(context, listen: false).pwd;
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          suffixIcon: Image.asset(
            _isEmailForm ? "assets/images/check.png" : "assets/images/circle.png",
          ),
          isDense: true,
  ...
  SizedBox repasswordTextFormField() {
    return SizedBox(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          suffixIcon: Image.asset(
            _isPasswordForm2 ? "assets/images/check.png" : "assets/images/circle.png",
          ),
          isDense: true,
          contentPadding: const EdgeInsets.symmetric(horizontal: 0, vertical: 10),
          suffixIconConstraints: const BoxConstraints(maxHeight: 20),
