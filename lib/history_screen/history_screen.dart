...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  TDataSet dsTagList = new TDataSet();
  ...
  Future<void> doTestPDF(String test_list_idx) async {
    ...
    if (ds.getRowCount() > 0) {
      ...
      String name = await ca.sqlToText("select 이름 from login_info where 아이디 = '$id' ");
        ...
        child: ListTile(
          ...
          title: Container(
            child: Row(
              children: [
                isCheckMode
                    ? Checkbox(value: isChk(index), onChanged: (value) {
  ...
  {
    String sql = 'delete from test_list where idx in (' + lChk.join(',') + '); ';
